...
#ifdef NEW_DYNAREC
DEFINE(r4300_core, recompiler_hot_state);
DEFINE(r4300_core, extra_memory);
DEFINE(recompiler_hot_state, dynarec_local);
DEFINE(recompiler_hot_state, cycle_count);
DEFINE(recompiler_hot_state, pending_exception);
DEFINE(recompiler_hot_state, pcaddr);
DEFINE(recompiler_hot_state, stop);
DEFINE(recompiler_hot_state, invc_ptr);
DEFINE(recompiler_hot_state, cp1_fcr0);
DEFINE(recompiler_hot_state, cp1_fcr31);
DEFINE(recompiler_hot_state, regs);
DEFINE(recompiler_hot_state, hi);
DEFINE(recompiler_hot_state, lo);
DEFINE(recompiler_hot_state, cp0_regs);
DEFINE(recompiler_hot_state, cp1_regs_simple);
DEFINE(recompiler_hot_state, cp1_regs_double);
DEFINE(recompiler_hot_state, rounding_modes);
DEFINE(recompiler_hot_state, branch_target);
DEFINE(recompiler_hot_state, pc);
DEFINE(recompiler_hot_state, fake_pc);
DEFINE(recompiler_hot_state, rs);
DEFINE(recompiler_hot_state, rt);
DEFINE(recompiler_hot_state, rd);
DEFINE(recompiler_hot_state, mini_ht);
DEFINE(recompiler_hot_state, memory_map);
#endif
